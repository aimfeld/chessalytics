...
Last activity: 2026-07-28 — Completed quick task 260728-soo: SEED-125 blobs_completed_at column fixes the tier-4 blob picker (84.8% of prod DB time → O(users) index probe)
