...
| 207-03-02 | 03 | 3 | RESET-01, RESET-05, RESET-07 | T-207-20 / T-207-21 / T-207-22 | Apex SPF byte-identical, Swizzonic still delivers; real mail arrives with `dkim=pass`/`dmarc=pass`; a no-password account receives nothing with identical copy | HUMAN-UAT (Step-0 gated) | N/A — see Manual-Only Verifications | N/A | ⬜ pending (deferrable) |
