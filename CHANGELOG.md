...
- The Train score screen no longer shows a greyed-out "Train again" button that could never be pressed. Sessions run once a day, so the screen now simply ends on the date of your next session. (SEED-122)
